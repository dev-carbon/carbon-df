...
Route::prefix('restaurant')->name('restaurant.')->group(function() {
    ...
    Route::get('/{restaurant}/dish/{dish}-{slug}', [\App\Http\Controllers\DishController::class, 'show'])->name('dish.show');
    Route::get('/{restaurant}/dish/{dish}-{slug}/rate', [\App\Http\Controllers\DishController::class, 'createRate'])->name('dish.rating.create');
    Route::post('/{restaurant}/dish/{dish}-{slug}/rate', [\App\Http\Controllers\DishController::class, 'storeRate'])->name('dish.rating.store');
});
